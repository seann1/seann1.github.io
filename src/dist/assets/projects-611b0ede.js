import"./modulepreload-polyfill-3cfb730f.js";import"./reel-c517e403.js";class j extends HTMLElement{constructor(){super();const r=this.getAttribute("title")||"",p=this.getAttribute("subtitle")||"",h=this.getAttribute("tags")||"",f=this.getAttribute("description")||"";let s=[];try{s=JSON.parse(this.getAttribute("pictures")||"[]")}catch{}const i=this.attachShadow({mode:"open"}),u=s.map((t,a)=>typeof t=="string"?`<img src="${t}" alt="${r}" data-index="${a}" class="gallery-thumb" />`:t.type==="youtube"?`
